...
###########################
# ~~~~~~~~~~~~~~~~~~~~~~~~~
# Preprocess only the BS-treated NDRI samples for validation in RefFreeEWAS2.0
# ~~~~~~~~~~~~~~~~~~~~~~~~~
# Necessary packages
...
idat <- "/Users/kevinjohnson/Documents/NDRI_Breast_5hmC/I.Data_Preprocessing/IDAT_Files"
...
NDRI_Betas_BMIQ <- Betas

# Application of BMIQ is computationally slow
save(NDRI_Betas_BMIQ, file="/Users/kevinjohnson/Komen_Normal_5mC/03.NDRI_Validation/Files/NDRI_Betas_BMIQ.RData")

# Post FunNorm and BMIQ adjustment
densityPlot(NDRI_Betas_BMIQ, main = "Beta_BMIQ", xlab = "Beta")
...
intersection <- intersect(rownames(NDRI_Betas_BMIQ), filtered.p)
# How many probes remain?  
length(intersection) #390,169

# Subset the FunNorm results
NDRI_Betas_BMIQ_sub = NDRI_Betas_BMIQ[intersection,]

#################################################                
# STEP 3: Extract Beta-values              
################################################# 
# Get Beta-Values
NDRI_Betas_processed_BMIQ <- NDRI_Betas_BMIQ_sub

# Write .csv file of NDRI betas. Final file to be used in RefFreeEWAS analyses.
write.csv(NDRI_Betas_processed_BMIQ, "/Users/kevinjohnson/Komen_Normal_5mC/03.NDRI_Validation/Files/NDRI_BMIQ_Betas_25July2016.csv")
